    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ✅ Corrigido: botão fechar nunca fica disabled.
               Antes, disabled={fase === 'revisando' && !revelado} prendia o
               usuário dentro do modal sem saída caso algo quebrasse (ex.:
               componente Alternativas travado, ExplicacaoIA sem resposta).
               Agora o botão sempre funciona; se a questão ainda não foi
               revelada, um confirm avisa antes de sair para evitar cliques
               acidentais — mas a saída nunca fica bloqueada. */}
          <button
            onClick={() => {
